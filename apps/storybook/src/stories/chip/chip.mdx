...
function MyComponent() {
  return (
    <div>
      <BakaChip>BakaText</BakaChip> {/* Default Chip */}
      <BakaChip selected={true}>BakaText</BakaChip> {/* Selected Chip */}
      <BakaChip hovered={true}>BakaText</BakaChip> {/* Hovered Chip */}
      <BakaChip focused={true}>BakaText</BakaChip> {/* Focused Chip */}
      <BakaChip dragged={true}>BakaText</BakaChip> {/* Dragged Chip */}
    </div>
  );
}
```
