...
To use the "BakaTopBar" component, simply import it from `@baka/react` and include it in your JSX code. Here's a basic example:

```jsx
import { BakaTopBar, BakaButton, BakaIcon } from "@baka/react";
...
To use the "BakaBottomBar" component, import it from `@baka/react` and add it to your JSX code. Here's a basic example:

```jsx
import { BakaBottomBar, BakaButton, BakaIcon } from "@baka/react";
