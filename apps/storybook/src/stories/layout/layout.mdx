...
The Layout module in the "@baka/react" library provides a set of components for building responsive and flexible layouts. These components help in organizing your content within containers, rows, and columns, allowing you to create dynamic and visually appealing designs. Below are the details of the available layout components.

## Installation

Before using the Layout module, ensure you have the "@baka/react" library installed in your project:
...
```javascript
import { BakaContainer, BakaRow, BakaColumn } from "@baka/react";
```
