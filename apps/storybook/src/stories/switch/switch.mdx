...
To use the Switch component in your project, make sure you have the `baka-ui` package installed. You can install it using npm or yarn:
...
Import the `BakaSwitch` component from `baka-ui` in your JavaScript or TypeScript file.
