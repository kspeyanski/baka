...
import { Demo } from "@/app/design/material-you/templates/demo";
...
<Demo src="/demos/material-you/button" />
...
To use the "Button" component, import it from `baka-ui` and include it in your JSX code. Here's a basic example:
