import{j as e}from"./jsx-runtime-9c4ae004.js";import{B as o}from"./radio-button-63059f31.js";import{u as c}from"./index-2ef8b458.js";import"./index-1b03fe98.js";import"./variant-class-names-08f4b07b.js";import"./state-attributes-f1b2bd32.js";function a(t){const n=Object.assign({h2:"h2",p:"p",code:"code",h3:"h3",pre:"pre",h4:"h4",ul:"ul",li:"li"},c(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"radiobutton",children:"RadioButton"}),`
...
`})}),`
`,e.jsxs(n.p,{children:["This example creates a group of radio buttons with the same ",e.jsx(n.code,{children:"name"})," attribute, allowing users to select their gender. Only one option can be selected at a time within the same group."]})]})}function l(t={}){const{wrapper:n}=Object.assign({},c(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(a,t)})):a(t)}const b={title:"Material You/Primitives/Radio Button",component:t=>e.jsx(o,{...t}),render:t=>e.jsx(o,{...t}),parameters:{layout:"centered",docs:{page:l}},tags:["autodocs"]},i={args:{checked:!0},argTypes:{checked:{control:"boolean"}},render:t=>e.jsx(o,{...t})};var s,r,d;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    checked: true
  },
  argTypes: {
...
}`,...(d=(r=i.parameters)==null?void 0:r.docs)==null?void 0:d.source}}};const g=["Basic"];export{i as Basic,g as __namedExportsOrder,b as default};
//# sourceMappingURL=RadioButton.stories-a22d9e69.js.map
