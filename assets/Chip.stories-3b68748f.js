import{j as a}from"./jsx-runtime-9c4ae004.js";import{B as t}from"./avatar-d223fbea.js";import{c as B,v as b}from"./variant-class-names-08f4b07b.js";import{s as u}from"./state-attributes-f1b2bd32.js";import{B as l}from"./icon-e14e50b0.js";import{u as p}from"./index-2ef8b458.js";import"./index-1b03fe98.js";const r=e=>{const{as:n="span",selected:i,hovered:x,focused:L,activated:j,disabled:f,variant:k,dragged:C,...g}=e;return a.jsx(n,{...g,className:B("baka-chip",e.className,u(e),b(k))})};function c(e){const n=Object.assign({h1:"h1",p:"p",h3:"h3",pre:"pre",code:"code",ul:"ul",li:"li"},p(),e.components);return a.jsxs(a.Fragment,{children:[a.jsx(n.h1,{id:"chip",children:"Chip"}),`
...
`})})]})}function m(e={}){const{wrapper:n}=Object.assign({},p(),e.components);return n?a.jsx(n,Object.assign({},e,{children:a.jsx(c,e)})):c(e)}const v={hovered:!1,focused:!1,activated:!1,dragged:!1,selected:!1},D={title:"Material You/Primitives/Chip",component:e=>a.jsx(r,{...e}),parameters:{layout:"centered",docs:{page:m}},args:{},tags:["autodocs"]},o={render:e=>{const{configuration:n,...i}=e;switch(n){case"BakaLabel & trailing icon":return a.jsxs(r,{...i,label:"BakaLabel & trailing icon",children:[a.jsx("span",{children:"BakaLabel"}),a.jsx(l,{children:"close"})]});case"Leading BakaIcon & label":return a.jsxs(r,{...i,label:"Leading BakaIcon & label",children:[a.jsx(l,{variant:"primary",children:"local_taxi"}),a.jsx("span",{children:"BakaLabel"})]});case"Leading icon, label & trailing icon":return a.jsxs(r,{...i,label:"Leading icon, label & trailing icon",children:[a.jsx(l,{variant:"primary",children:"local_taxi"}),a.jsx("span",{children:"BakaLabel"}),a.jsx(l,{children:"close"})]});case"BakaLabel & Avatar":return a.jsxs(r,{...i,label:"BakaLabel & Avatar",children:[a.jsx(t,{children:e.selected?a.jsx(l,{variant:["filled"],children:"check"}):a.jsx("img",{src:"./avatar-light.svg"})}),a.jsx("span",{children:"BakaLabel"})]});case"BakaLabel, avatar & icon":return a.jsxs(r,{...i,label:"BakaLabel, avatar & icon",children:[a.jsx(t,{children:e.selected?a.jsx(l,{variant:["filled"],children:"check"}):a.jsx("img",{src:"./avatar-light.svg"})}),a.jsx("span",{children:"BakaLabel"}),a.jsx(l,{children:"close"})]});default:return a.jsx(r,{...i,children:"BakaLabel"})}},args:{variant:"normal",configuration:"BakaLabel only",...v},argTypes:{configuration:{control:"radio",map:{"BakaLabel only":null,"BakaLabel & trailing icon":"trailing-icon","Leading BakaIcon & label":"leading-icon","Leading icon, label & trailing icon":"leading-icon-trailing-icon","BakaLabel & Avatar":"avatar","BakaLabel, avatar & trailing icon":"avatar-trailing-icon"},options:["BakaLabel only","BakaLabel & trailing icon","Leading BakaIcon & label","Leading icon, label & trailing icon","BakaLabel & Avatar","BakaLabel, avatar & icon"]},variant:{control:"radio",map:{normal:null,elevated:"elevated"},options:["normal","elevated"]}}};var s,d,h;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: props => {
    const {
      configuration,
      ...other
...
//# sourceMappingURL=Chip.stories-3b68748f.js.map
